        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-lg font-semibold leading-6 text-zinc-900">Réactiver le client</h3>
                </div>

                <p className="text-sm text-zinc-500 mb-6">
                    Réactiver le client <strong className="text-zinc-900 font-bold">{clientName}</strong> ?
                ...
                <div className="flex justify-end gap-3">
                    ...
                    <button
                        ...
                        onClick={onConfirm}
                        disabled={isLoading}
                        className="px-4 py-2 text-sm font-semibold text-white bg-emerald-600 rounded-xl hover:bg-emerald-700 transition disabled:opacity-50"
                    >
